...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                分类管理 <small>全部类别</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/adminn/goIndex.do"><i
                        class="fa fa-dashboard"></i> 首页</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/adminMajor/findAll.do">分类管理</a></li>
            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <form id="add-form" action="${pageContext.request.contextPath}/adminMajor/add.do">
                                        <input type="text" id="add-msg"  name="name">
                                        <button type="submit" title="添加类别">
                                            <i class="fa fa-file-o"></i> 添加类别
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <c:forEach items="${pageInfo.list}" var="major">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/adminMajor/delete.do?id=${major.id}"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/adminMajor/findAll.do?page=1&size=${pageInfo.pageSize}"
                                   aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/adminMajor/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li>
                                    <a href="${pageContext.request.contextPath}/adminMajor/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/adminMajor/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/adminMajor/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/adminMajor/findAll.do?page=1&size="
            + pageSize;
    }
