...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/web/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/web/plugins/treeTable/jquery.treetable.theme.default.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/web/plugins/select2/select2.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/web/plugins/colorpicker/bootstrap-colorpicker.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/web/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/web/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.css">
</head>
