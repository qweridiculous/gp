    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/adminComment/findAll.do">评论管理</a></li>
            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <%--<div class="box-tools pull-right">
                            <div class="has-feedback">
                                <input id="search" type="text" class="form-control input-sm" placeholder="根据用户名搜索">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc">评论用户</th>
                                <th class="sorting_asc sorting_asc_disabled">评论内容</th>
                                <th class="sorting_desc sorting_desc_disabled">评论书籍</th>
                                <th class="sorting_desc sorting_desc_disabled">评论时间</th>
                                <th class="sorting_desc sorting_desc_disabled">回复数量</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="comment">
                                <tr>
                                    ...
                                    <td><fmt:formatDate value="${comment.comment_time}" pattern="yyyy-MM-dd" /> </td>
                                    <td>${comment.comment_replies.size() }</td>
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/adminComment/deleteComment.do?cid=${comment.comment_id}"
                                           class="btn bg-olive btn-xs">移除</a>
                                        <a href="${pageContext.request.contextPath}/adminComment/findByCid.do?cid=${comment.comment_id}"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/adminComment/findAll.do?page=1&size=${pageInfo.pageSize}"
                                   aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/adminComment/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li>
                                    <a href="${pageContext.request.contextPath}/adminComment/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/adminComment/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/adminComment/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/adminComment/findAll.do?page=1&size="
            + pageSize;
    }
